  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: SAP_COLORS.lightGray }}>
      ...
      >
        ...
        <div>
          <h1 style={{ margin: 0, fontSize: '1.8em' }}>Data Reconciliation</h1>
          <p style={{ margin: '5px 0 0 0', opacity: 0.9 }}>Unified reconciliation across all systems</p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        >
          <Database size={64} style={{ color: SAP_COLORS.sapBlue, marginBottom: '20px', opacity: 0.3 }} />
          <h2 style={{ color: SAP_COLORS.textPrimary, marginBottom: '10px' }}>Data Reconciliation Hub</h2>
          <p style={{ color: SAP_COLORS.textSecondary, marginBottom: '30px' }}>
            Unified reconciliation across SAP (TMH), JD Edwards (Raymond), and THD systems.
          </p>
          <div
            style={{
          ...
          >
            ...
            <ul style={{ color: SAP_COLORS.textSecondary, lineHeight: '1.8' }}>
              <li>Cross-system transaction matching</li>
